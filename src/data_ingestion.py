...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            #$env:GOOGLE_APPLICATION_CREDENTIALS = "C:\Users\shivakiran\Downloads\ace-botany-474202-m8-efb32fed1bd1.json" in power shell
    ...
    def run(self):
        try:
            ...
            logger.error(f"Custom Execption : {str(ce)}")
        finally:
            logger.info("Data Ingestion completed")
            
if __name__ =="__main__":
    data_ingestion = DataIngestion(read_yml(CONFIG_PATH))
    data_ingestion.run()
